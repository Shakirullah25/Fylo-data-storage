                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                           ...
                           Stack(
  children: [
    // Background container with a gradient for the entire bar
    Container(
      height: 10,
    ...
    // Foreground container that masks out the unfilled part
    Container(
      height: 10,
      width: MediaQuery.of(context).size.width * (815 / 1000),
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: AppColors.primaryGradient as Colors,
          begin: Alignment.centerLeft,
          end: Alignment.centerRight,
        ),
        borderRadius: BorderRadius.circular(5),
