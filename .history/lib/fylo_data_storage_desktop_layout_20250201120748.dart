...
class FyloDataStorageDesktopLayout extends StatelessWidget {
  ...
  shaderCallback: (Rect bounds) {
    return LinearGradient(
      colors: [
        AppColors.gradientStart, // Replace with your start color
        AppColors.gradientEnd,   // Replace with your end color
      ],
      stops: [0.0, 1.0],
  ...
  blendMode: BlendMode.srcIn, // Ensures the gradient only applies to the progress indicator
  child: LinearProgressIndicator(
    value: 815 / 1000, // 815GB used out of 1000GB
    backgroundColor: Colors.grey,
    // Set valueColor to white since the ShaderMask will apply the gradient over it.
